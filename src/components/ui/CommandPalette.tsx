...
export default function CommandPalette() {
  ...
  const commands: Command[] = [
    ...
    {
      id: "quick-connect",
      label: "Instant Connect (@kaisejan)",
      description: "1-click login with your GitHub repos",
      icon: <Github size={14} />,
      shortcut: ["Q", "C"],
      group: "Actions",
      action: () => { signIn("quick-connect", { username: "kaisejan", callbackUrl: "/dashboard" }); },
    },
    {
      id: "github",
      label: "Connect via GitHub OAuth",
      description: "Sign in with registered OAuth App",
      icon: <Github size={14} />,
      group: "Actions",
